...
std_aligned_intensity_CH2 = aligned_intensity_CH2.std(axis=1)
mean_aligned_intensity_CH3 = aligned_intensity_CH3.mean(axis=1)
std_aligned_intensity_CH3 = aligned_intensity_CH3.std(axis=1)
...
for track in random_tracks:
    if track in aligned_intensity_CH2.columns:
        plt.scatter(aligned_intensity_CH2.index, aligned_intensity_CH2[track], label=f'TRACK_ID {track} - C2',
                    alpha=0.7)
        plt.scatter(aligned_intensity_CH3.index, aligned_intensity_CH3[track], label=f'TRACK_ID {track} - C3',
                    alpha=0.7)
